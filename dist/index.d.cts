...
interface ClaudeClientConfig {
    ...
    retryDelay?: number;
    maxTokens?: number;
    model?: 'claude-sonnet-4-20250514' | 'claude-opus-4-20250514' | 'gpt-3.5-turbo' | 'gpt-3.5-turbo-16k' | 'gpt-4' | 'gpt-4-turbo' | 'gpt-4o' | 'gpt-4-32k' | string;
    temperature?: number;
...
declare function createAIClient(config: (ClaudeClientConfig | OpenAIClientConfig) & {
    providerOverride?: string;
}): AIClient;
